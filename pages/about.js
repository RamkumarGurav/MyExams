...
// import {qs} from "../data/qsjs";

const about = () => {
  // console.log(process.env.API_URL);
  // const x = qs.questions.map((item, i) => ({ ...item, qId: i }));
  // console.log(x);
  return (
    <Layout>
      <Head>
        <title>About | MyExams</title>
      </Head>
...
// "I am ram"  convert this string into an array
...
// "I am ram"  convert this string into an array without spaces
